...
tf_model = wc.TF()
PARSE_PATH = '/nfs_shares/jzl0166_home/bc/data'
#PARSE_PATH = '/Users/lijing/Desktop/spatialNLI/data/geo'

FILE = 'base/geobase.sql'
FILEKEY1 = 'base/key_w.txt'
FILEKEY2 = 'base/human_info_w.txt'
FILEKEY3 = 'base/special_w.txt'
class Question:
    ...
    def exact_match(self, word, idx, le, line):
        ...
        elif word in ['biggest', 'highest','most','greatest','longest','maximum','largest','tallest','fewest','smallest','minimum','sparsest','lowest','shortest','least']:
            if word in ['biggest', 'highest','most','greatest','longest','maximum','largest','tallest']:
                flag = 'argmax'
            elif word in ['fewest','smallest','minimum','sparsest','lowest','shortest','least']:
                flag = 'argmin'
